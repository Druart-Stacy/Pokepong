...
# Afficher l'écran du gagnant ou du perdant
    if game_state == "player1_wins":
        ...
        screen.draw.text("Tu as gagné. Appuie sur 'R' pour redémarrer.", (WIDTH // 2 - 250, HEIGHT // 2), color="red", fontsize=30)
        ...
        screen.draw.text("Tu as perdu. Appuie sur 'R' pour redémarrer.", (WIDTH // 2 - 250, HEIGHT // 2), color="red", fontsize=30)
        ...
        screen.draw.text("Pause. Appuie sur 'P' pour reprendre.", (WIDTH // 2 - 200, HEIGHT // 2), color="red", fontsize=30)
